...
{
	[RouteArea("Admin")]
	public class AboutController : BaseController<ResponseModel<About>>
	{
		// GET: Admin/About
		public ActionResult Index()
		{
			CommonViewModel.ObjList = _context.Abouts.AsNoTracking().ToList();
		...
		public ActionResult Save(About viewModel)
		{
			try
			{
				if (viewModel != null && viewModel != null)
				{
					...
					try
					{
						...
						CommonViewModel.RedirectURL = Url.Action("Index", "About", new { area = "Admin" });
